...
<li><strong><input id="accordion1" type="checkbox" /> <label for="accordion1">Drama Education &amp; Oral Communication</label></strong>
...
<td style="width: 50%;">
<ul class="jekyllcodex_accordion">
<li><strong><input id="accordion2" type="checkbox" /> <label for="accordion2">EL Reading Portfolio</label></strong>
...
<td style="width: 50%;">
<ul class="jekyllcodex_accordion">
<li><strong><input id="accordion3" type="checkbox" /> <label for="accordion3">Literature Journaling</label></strong>
